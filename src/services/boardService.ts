...
export default class BoardService {
    ...
    constructor(albebraicNotationPosition: AlgebraicNotation) {
        const postion = 
            AlgebraicNotationService.parseAlgebraicNotationToPosition(albebraicNotationPosition);
    ...
    getValidMoves(): AlgebraicNotation[] {
        ...
        return validMoves.map(
            position => AlgebraicNotationService.parsePositionToAlgebraicNotation(position)
        );
    }

    getValidMovesForPositions(albebraicNotationPositions: AlgebraicNotation[]): AlgebraicNotation[] {
        const validMoves = albebraicNotationPositions.flatMap(albebraicNotationPosition => {
            const position = AlgebraicNotationService.parseAlgebraicNotationToPosition(albebraicNotationPosition);
